...
class _FireMapState extends State<FireMap> {
  ...
  void _addPolylines(){
    ...
    lstLatLng.add(LatLng(-10.180197, -48.334082));
    lstLatLng.add(LatLng(-10.182910, -48.337223));
    lstLatLng.add(LatLng(-10.184420, -48.339154));
    lstLatLng.add(LatLng(-10.184317, -48.344455));
    lstLatLng.add(LatLng(-10.184516, -48.348203));
    lstLatLng.add(LatLng(-10.184136, -48.359346));
    lstLatLng.add(LatLng(-10.184136, -48.359346));
    lstLatLng.add(LatLng(-10.178185, -48.362423));
    lstLatLng.add(LatLng(-10.176142, -48.361471));
    lstLatLng.add(LatLng(-10.177388, -48.359797));
    lstLatLng.add(LatLng(-10.179718, -48.359791));
  ...
  void _add() async {
    ...
    var marker1 = Marker(
      ...
      icon: stopIcon,
      infoWindow: InfoWindow(title: "Ponto de Ônibus", snippet: "Linhas:\n• 090"),
      markerId: MarkerId("1"),
    );
    var marker2 = Marker(
